...
/* Module Version: 5.8 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n UART_FIFO -lang verilog -synth lse -bus_exp 7 -bb -arch xo3c00f -type ebfifo -depth 64 -width 8 -rwidth 8 -no_enable -pe 4 -pf 60  */
...
module UART_FIFO (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    defparam UART_FIFO_0_0.FULLPOINTER1 = "0b00001111110000" ;
    defparam UART_FIFO_0_0.FULLPOINTER = "0b00010000000000" ;
    defparam UART_FIFO_0_0.AFPOINTER1 = "0b00001110110000" ;
    defparam UART_FIFO_0_0.AFPOINTER = "0b00001111000000" ;
    defparam UART_FIFO_0_0.AEPOINTER1 = "0b00000001010000" ;
    defparam UART_FIFO_0_0.AEPOINTER = "0b00000001000000" ;
    ...
    defparam UART_FIFO_0_0.DATA_WIDTH_R = 18 ;
    defparam UART_FIFO_0_0.DATA_WIDTH_W = 18 ;
    FIFO8KB UART_FIFO_0_0 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), 
