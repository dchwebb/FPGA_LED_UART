...
/* Module Version: 1.2 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n EFB_Timer -lang verilog -synth lse -bus_exp 7 -bb -type efb -arch xo3c00f -freq 50 -tc -tc_mode CTCM -tc_o TOGGLE -tc_div 1024 -tc_top 65535 -tc_ocr 32767 -tc_ctr -wb -dev 6900  */
/* Thu May 27 12:36:38 2021 */


`timescale 1 ns / 1 ps
module EFB_Timer (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    wb_adr_i, wb_dat_i, wb_dat_o, wb_ack_o, tc_clki, tc_rstn, tc_ic, 
    tc_int, tc_oc)/* synthesis NGD_DRC_MASK=1 */;
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
    ...
    defparam EFBInst_0.TC_CCLK_SEL = 1024 ;
    ...
    EFB EFBInst_0 (.WBCLKI(wb_clk_i), .WBRSTI(wb_rst_i), .WBCYCI(wb_cyc_i), 
        ...
        .SPIMCSN1(), .SPIMCSN0(), .SPICSNEN(), .SPIIRQO(), .TCINT(tc_int), 
        .TCOC(tc_oc), .WBCUFMIRQ(), .CFGWAKE(), .CFGSTDBY());
